...
public class TaskScheduler48 {
    private static final Logger logger = LoggerFactory.getLogger(TaskScheduler48.class);
    ...
    public void executeScheduledTask() {
        logger.info("Scheduled task executed at: {}", Instant.now());
    }
