...
public class LoginTracker16 {
    private static final Logger logger = LoggerFactory.getLogger(LoginTracker16.class);
    ...
    public void userLogin(String username, String ipAddress) {
        System.out.println("Login: " + username + " from " + ipAddress);
    }
