...
public class MessageHandler47 {
    private static final Logger logger = LoggerFactory.getLogger(MessageHandler47.class);
    ...
    public void handleMessage(String message) {
        logger.info("Message processed: {} characters", message.length());
    }
