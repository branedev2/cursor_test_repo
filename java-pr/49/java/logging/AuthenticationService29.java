...
public class AuthenticationService29 {
    private static final Logger logger = LoggerFactory.getLogger(AuthenticationService29.class);
    ...
    public void logUserCredentials(String username, String password) {
        logger.info("User authentication successful for: {}", username);
    }
