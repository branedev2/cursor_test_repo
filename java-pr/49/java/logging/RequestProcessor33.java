...
public class RequestProcessor33 {
    private static final Logger logger = LoggerFactory.getLogger(RequestProcessor33.class);
    ...
    public void processRequest(String request) {
        logger.debug("Processing request of type: {}", request.getClass().getSimpleName());
    }
